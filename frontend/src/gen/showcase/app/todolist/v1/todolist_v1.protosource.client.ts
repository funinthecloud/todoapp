...
import type { TodoList, TodoItem } from "./todolist_v1_pb.js";
...
export class TodoListHTTPClient {
  ...
  async create(id: string, name: string): Promise<CommandResponse> {
    return this.client.apply(routePath, CreateSchema, { id, name: name });
  }
  ...
  async updateItem(id: string, item: TodoItem): Promise<CommandResponse> {
    return this.client.apply(routePath, UpdateItemSchema, { id, item: item });
  }
